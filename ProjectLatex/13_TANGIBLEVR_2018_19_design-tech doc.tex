...
\vspace{1cm}
\rightline{Giulia Meneghin}
\rightline{Giuseppe Mauri}
\end{large}
\vspace{0.5cm}
...
The therapist will have two main tasks: to translate the VR child's verbal communication into our system input through the website and to coordinate the communication between the two children, stimulating them to interact with each other. 
...
In order to better supervise the collaboration between the two children, the therapist can also use the screen mirroring that will transmit the contents of the smartphone on the PC. The therapist can then see in real time what happens in the virtual world so as to have a complete view of the game. The therapeutic activity will be facilitated because the therapist will be able to interact better with the child immersed in the virtual world.
\begin{figure}[h!]
\centering
\hspace*{\fill}
\begin{subfigure}[tl]{0.46\linewidth}
\includegraphics[width=\linewidth]{TherapistUserExperience.jpg}
\caption{\textbf{Therapist User Experience}}
\end{subfigure}\hfill
\begin{subfigure}[tr]{0.46\linewidth}
...
\textbf{At this point there can be three different scenarios:}
\begin{enumerate}
\item \textbf{ First scenario (both children make the right choice)}\\
...
\item \textbf{Second scenario(both children make the wrong choice)}\\
...
\item \textbf{Third scenario(one of the two children makes the right choice, the other the wrong one)}\\
...
\textbf{At this point there can be three different scenarios:}
\begin{enumerate}
\item \textbf{First scenario (both children choose the \underline{Same Correct food})}\\
...
\item  \textbf{Second scenario (both children choose the \underline{Same Wrong food})}\\
...
\item \textbf{Third scenario (the children choose \underline{Two Different Wrong food})}\\
...
\hspace*{\fill}
\begin{subfigure}[tr]{0.3\linewidth}
\includegraphics[width=\linewidth]{PositiveCase.jpg}
...
\begin{figure}[ht!]
\centering
\includegraphics[height=4.6cm,width=6.5cm]{NeedRepresentation.jpg}
\caption{\textbf{VR Need Representation}}
\end{figure}
\subsubsection{Smart Object}
...
\begin{figure}[ht!]
\centering
\includegraphics[height=4.6cm,width=6.5cm]{NeedRepresentationSam.jpg}
\caption{\textbf{SAM Need Representation}}
\end{figure} 
\clearpage
...
\begin{figure}[ht!]
\centering
\includegraphics[height=4.8cm,width=7cm]{FoodDesireRepresentation.JPG}
\caption{\textbf{VR Need Representation}}
\end{figure}
\subsubsection{Smart Object}
...
\begin{figure}[ht!]
\centering
\includegraphics[height=4.8cm,width=7cm]{FoodDesireRepresentationSam.jpg}
\caption{\textbf{SAM Need Representation}}
\end{figure}

\subsection{Summarising Representation of Need}
...
\caption{\textbf{Client-Server Architecture}}
\end{figure}   
...
\caption{\textbf{Deployment Diagram}}
\end{figure}
...
\caption{\textbf{Website Interface}}
\end{figure}
...
\item Simone C. \& Franca Garzotto \& Mirko Gelsomini \& Mattia M. \& Francesco C. (2016). A Smart Dolphin for Children with Neurodevelopmental Disorders
...
\item Lizbeth Escobedo \& Mónica Tentori Eduardo Quintana \& Jesus Favela \& Daniel Garcia-Rosas (2014). Using Augmented Reality to Help Children with Autism Stay Focused

\item Lal Bozgeyikli \& Andrew Raij \& Srinivas Katkoori \& Redwan Alqasemi (2017). A Survey on Virtual Reality for Individuals with Autism Spectrum Disorder: Design Considerations

\item Franca Garzotto \& Mirko Gelsomini \& Daniele Occhiuto \& Vito Matarazzo \& Nicolò Messina (2017).  Wearable Immersive Virtual Reality for Children with Disability: a Case Study

\item Franca Garzotto \& Nicolò Messina \& Vito Matarazzo \& Lukasz Moskwa \& Gianluigi Oliva \& Riccardo Facchini (2018). Empowering Interventions for Persons with Neurodevelopmental Disorders through Wearable Virtual Reality and Bio-sensors

\item Joan Mora-Guiard \& Ciera Crowell \& Narcis Pares \& Pamela Heaton (2016). Lands of Fog: Helping Children with Autism in Social Interaction through a Full-Body Interactive Experience

\item Antonietta Difonzo (2018). Il ruolo delle Nuove Tecnologie nel Progetto Psicoeducativo per l'alunno autisticoù

\item Nicola Filippi \& Jacopo G. Romani (2016). Tecnologie a sostegno delle persone con disturbi dello spettro autistico 

\item http://tecnologieperlautismo.org/

\item http://www.oltrelabirinto.it/news.aspx?idC=645
