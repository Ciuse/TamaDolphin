...
\vspace{1cm}
\rightline{Giulia Meneghin, matricola 913185}
\rightline{Giuseppe Mauri, matricola 905306}
\end{large}
\vspace{0.5cm}
...
Our idea has as its basic concept the \textbf{Collaboration} between two children with different skills. The game has as a protagonist a dolphin that it presents itself in the form of a 3D model in the virtual world and a puppet in the real world. The two dolphin representations will show the same needs through different feedback depending on the technology used.
...
\textbf{At this point there can be three other different scenarios:}
\begin{enumerate}
